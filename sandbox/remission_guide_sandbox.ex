defmodule CentrixCore.RemissionGuideSandbox do
  def test_remission_guide_sandbox do
    ...
    with {:ok, [xml: xml, clave_acceso: access_key]} <- CentrixCore.XmlRemissionGuideBuilder.build_remission_guide(guia_remision_params),
